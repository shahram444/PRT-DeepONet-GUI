...
%(substrates)s
  ...
  <!-- ===================== SWEEPING =====================
       ...
       the generator draws Peclet and Damkohler log-uniformly from these ranges
       instead of using the single values above. Log-uniform, not uniform:
       these quantities span decades and a uniform draw would put nine tenths
       of the runs in the top decade.
       ==================================================== -->
  <!--
  <sweep>
